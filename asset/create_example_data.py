...
random_angles = np.random.rand(file_num,batch_num,100)*360.
np.save("../input/random_angles.npy", arr=random_angles)
...
for l in range(5):
    ...
    with h5.File('../input/example_data_file_{}.h5'.format(l),'w') as h5file:
        ...
        print("A new h5 file containing example datasets in created in {}".format('../input/example_data_file_{}.h5'.format(l)))
